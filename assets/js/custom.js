document.addEventListener("DOMContentLoaded", () => {
  ...
  (() => {
    ...
    const typeTabs = sliderSection.querySelectorAll(
      ".rn-before-after-slider-tab__type-tab",
    );
    const panels = sliderSection.querySelectorAll(
      ".rn-before-after-slider-tab__panel",
    );
    ...
    function updateActivePanel() {
      panels.forEach((panel) => {
        ...
        const isActive = panelType === currentType;
  ...
  (() => {
    const timelineSection = document.querySelector(".rn-timeline");
    if (!timelineSection) return;

    const tabs = timelineSection.querySelectorAll(".rn-timeline__tab");
    const panels = timelineSection.querySelectorAll(".rn-timeline__panel");
    ...
    tabs.forEach((tab) => {
      tab.addEventListener("click", () => {
        ...
        const timelineId = tab.dataset.timeline;
        const panel = timelineSection.querySelector(`#${timelineId}`);
        if (panel) {
...
window.addEventListener("load", function () {
  ...
  document
    .querySelectorAll(".rn-clinic-intro__video-wrapper")
    ?.forEach(function (wrapper) {
      wrapper.addEventListener("click", function () {
        ...
        const iframeWrapper = wrapper.querySelector(
          ".rn-clinic-intro__iframe-wrapper",
        );
  ...
  // YouTube video player for rn-youtube
  document
    .querySelectorAll(".rn-youtube__video-wrapper")
    ?.forEach(function (wrapper) {
      wrapper.addEventListener("click", function () {
        if (wrapper.classList.contains("playing")) return;
